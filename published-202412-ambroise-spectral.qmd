...
Comparison of clustering algorithms on PCA embedded and full MNIST with ARI and NMI metrics: k-means++ (pink), EM (green), Ward Clustering (red), GIT (blue), and Spectral Bridges (purple).
:::

<!-- ::: {#fig-mnist-pca-scores-table} -->
...
Table: Comparison table of clustering algorithms on PCA embedded and full MNIST with ARI and NMI metrics. The highest mean scores among tested algorithms are in bold.
<!-- #::: -->
...
![](figures/mnist_umap_summary.pdf)

Comparison  of clustering algorithms on UMAP embedded MNIST with ARI and NMI metrics: k-means++ (pink), EM (green), Ward Clustering (red), GIT (blue), Spectral Bridges (purple).
:::

<!-- ::: {#fig-mnist-umap-scores-table} -->
...
Table: Comparison table of clustering algorithms on UMAP embedded MNIST with ARI and NMI metrics. The highest mean scores among tested algorithms are in bold.
<!-- ::: -->
...
![](figures/cancer_summary.pdf)


Comparison of clustering algorithms on the UCI Breast Cancer dataset with ARI and NMI metrics: k-means++ (pink), EM (green), Ward Clustering (red), GIT (blue), and Spectral Bridges (purple).
:::

<!-- :::{#fig-cancer-scores-table} -->
...
Table: Comparison table of clustering algorithms on the UCI Breast Cancer dataset with ARI and NMI metrics. The highest mean scores among tested algorithms are in bold.
<!-- ::: -->
...
![](figures/synthetic_summary.pdf)

Comparison of clustering algorithms on toy datasets with ARI and NMI metrics. 
:::

<!-- ::: {#fig-synthetic-scores-table} -->
...
Table: Comparison table of clustering algorithms on toy datasets with ARI and NMI metrics. The highest mean scores among tested algorithms are in bold.
<!-- ::: -->

...
|         | SB        | **\(\boxed{0.5789}\)** | **\(\boxed{0.6875}\)** | **\(\boxed{0.7110}\)** | **\(\boxed{0.6983}\)** | **\(\boxed{0.6619}\)** |
...
|         | SB        | **\(\boxed{0.6592}\)** | **\(\boxed{0.7616}\)** | **\(\boxed{0.7895}\)** | **\(\boxed{0.7846}\)** | **\(\boxed{0.7628}\)** |

Table: Comparison of clustering algorithms with ARI and NMI metrics. The highest scores in each row are boxed.

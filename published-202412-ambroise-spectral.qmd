...
![ARI and NMI scores of k-means++ (pink), EM (green), Ward Clustering (red), GIT (blue), and Spectral Bridges (purple).](figures/mnist_pca_summary.pdf)
...
![ARI and NMI scores of k-means++ (pink), EM (green), Ward Clustering (red), GIT (blue), Spectral Bridges (purple).](figures/mnist_umap_summary.pdf)
...
![ARI and NMI scores of k-means++ (pink), EM (green), Ward Clustering (red), GIT (blue), and Spectral Bridges (purple) on the UCI Breast Cancer dataset.](figures/cancer_summary.pdf)
...
Comparison of clustering algorithms on the UCI Breast Cancer dataset with ARI and NMI metrics. The highest scores in each row are in bold.
:::
...
![ARI and NMI scores of Spectral Bridges and competitors on standard synthetic toy datasets.](figures/synthetic_summary.pdf){height=75%}
...
|         | GIT       | $0.8895$          | $0.9920$          | $\mathbf{1.0000}$ | $0.5693$          |
|         | SB        | $\mathbf{0.9996}$ | $\mathbf{0.9912}$ | $\mathbf{1.0000}$ | $\mathbf{1.0000}$ |
...
|         | GIT       | $0.9103$          | $0.9812$          | $\mathbf{1.0000}$ | $0.6210$          |
|         | SB        | $\mathbf{0.9995}$ | $\mathbf{0.9787}$ | $\mathbf{1.0000}$ | $\mathbf{1.0000}$ |


Comparison of clustering algorithms on toy datasets with ARI and NMI metrics. The highest scores in each row are in bold.
:::
